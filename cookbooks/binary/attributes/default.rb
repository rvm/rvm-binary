...
default[:rvm][:requirements][:debian] = [
  ...
  "sudo apt-get --no-install-recommends --quiet --yes install build-essential openssl libreadline6 libreadline6-dev curl git-core zlib1g zlib1g-dev libssl-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt-dev autoconf libc6-dev ncurses-dev automake libtool bison subversion pkg-config libgdbm-dev"
]
...
default[:rvm][:requirements][:centos] = [
  "curl -L http://curl.haxx.se/ca/cacert.pem -o /etc/pki/tls/certs/ca-bundle.crt",
